...
?>
    ...
    <?php } else { ?>
        <form action="?modul=mod_transaksi&action=save" id="formtransaksi" method="POST" enctype="multipart/form-data">
            ...
            $qry = mysqli_query($koneksidb, "SELECT a.*, b.nm_member, c.nm_kamar FROM tst_penjualan a INNER JOIN daftarmember b ON a.idmember = b.idmember INNER JOIN mst_kamar c ON a.idproduk = c.id_kamar WHERE no_invoice='$kode'");
